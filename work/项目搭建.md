...
<img src="../assets/images/work/02.png" alt="node-app.png" style="zoom:80%;" />

2. 安装`stylelint`和`stylelint-config-standard`
...
3. 在项目根目录新建`.stylelintrc.js`，配置相对简单：
...
4. 在插件市场安装好 stylelint 插件后，在 `settings.json` 配置自动修复：
